// GENERATED from lib/schema.sql -- do not hand-edit.
...
export const SCHEMA_TABLES = `-- ============ MASTER (diedit admin, is_active = soft delete) ============
...
export const SCHEMA_INDEXES = `CREATE INDEX IF NOT EXISTS idx_readings_tank_time ON tank_readings(tank_id, reading_at DESC);
