...
const STAMPABLE = new Set([
  ...
  'shift_crew',
  'maintenance_tasks',
  // Lembar tugas. Baris (task_sheet_rows) ikut di sini walau bisa lahir di HP:
  // begitu server menerimanya lewat sync, baris itu harus menyebar ke handset
  // lain, dan delta pull adalah satu-satunya jalannya (dok 07 §7).
  'task_sheets',
  'task_sheet_columns',
  'task_sheet_rows',
]);
